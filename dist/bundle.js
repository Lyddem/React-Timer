...
var App = function (_React$Component) {
  ...
  _createClass(App, [{
    ...
    value: function componentWillMount() {
      ...
      setTimeout(function () {
        _this2.setState({
          startSec: --_this2.state.startSec
        });
      }, 1000);
    }
  }, {
    ...
    value: function handleTimeout() {
      ...
      var test = --this.state.startSec; //'3661'
    ...
    value: function clicked() {
      ...
      var validStart = re.test(this.state.start);
      var validEnd = re.test(this.state.end);
      var start = this.state.start.split(":");
      var end = this.state.end.split(":");
      var startSec = Number(start[0]) * 3600 + Number(start[1]) * 60 + Number(start[2]);
      var endSec = Number(end[0]) * 3600 + Number(end[1]) * 60 + Number(end[2]);
      // validate inputs
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { id: 'timer' },
          'Start Time ',
          _react2.default.createElement('input', { type: 'text', placeholder: 'hh:mm:ss', onChange: function onChange(e) {
              _this3.setState({ start: e.target.value });
            } }),
          _react2.default.createElement('br', null),
          'End Time ',
          _react2.default.createElement('input', { type: 'text', placeholder: 'hh:mm:ss', onChange: function onChange(e) {
              _this3.setState({ end: e.target.value });
            } }),
          ' ',
          _react2.default.createElement('br', null),
          _react2.default.createElement('br', null),
